...
// double LQRControl::lqrControl(vector<double>robot_state,vector<double>refer_path, MatrixXd A, MatrixXd B, MatrixXd Q, MatrixXd R){
//     MatrixXd X(3,1);
...
//     MatrixXd u = -K*X;   // 2*1
//     return u(0,0),u(1,0);  // return delta_theta   角速度偏差值
// }

// vector<MatrixXd> LQRControl::stateSpace(float ref_yaw, float dt , float v){   
//     MatrixXd A(3,3);
//     MatrixXd B(3,2);
...
// vector<MatrixXd> LQRControl::getQR(float q, float r){
//     MatrixXd Q(3,3);
//     MatrixXd R(2,2);
//     Q<<q,0,0,
//         0,q,0,
